...
public class SignatureChecking {
    ...
    private static final String APP_SIGNATURE = "F230F0D8473EE54F2454F509C9C9AE98FAC660CF";
     ...
     */
    public static boolean validateAppSignature(Context context) throws NameNotFoundException, NoSuchProviderException, NoSuchAlgorithmException, TamperingException {
        ...
        throw new TamperingException("Key verification failed");
    }
